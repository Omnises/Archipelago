...
equip_items: list[ItemData] = [ItemData(x[0], x[1], x[2] | equipItemOffset) for x in [
    ...
    ("Weapon (Yuna): Lucid Ring I",           ItemClassification.useful, 0x0015),  # Offset=0164 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Silence Ward [8045h], Confuse Ward [804Fh]} }
    ...
    ("Weapon (Yuna): Lucid Ring II",           ItemClassification.useful, 0x0022),  # Offset=0234 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=3 {Silence Ward [8045h], Confuse Ward [804Fh], Poison Ward [803Dh]} }
    ...
    ("Weapon (Auron): Defending Bracer I",    ItemClassification.useful, 0x0028),  # Offset=0294 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Stoneproof [8038h], Poisonproof [803Ch]} }
    ...
    ("Weapon (Auron): Defending Bracer II",    ItemClassification.useful, 0x002c),  # Offset=02D4 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Silenceproof [8044h], Darkproof [8048h]} }
    ...
    ("Weapon (Yuna): Phantom Ring I",         ItemClassification.useful, 0x002f),  # Offset=0304 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=4 {Ice Eater [8025h], Fire Eater [8021h], Lightning Eater [8029h], Empty} }
    ...
    ("Weapon (Yuna): Phantom Ring II",         ItemClassification.useful, 0x0033),  # Offset=0344 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=4 {Water Eater [802Dh], Fire Eater [8021h], Lightning Eater [8029h], Empty} }
    ...
    ("Weapon (Auron): Defending Bracer III",    ItemClassification.useful, 0x0035),  # Offset=0364 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=4 {Darkproof [8048h], Deathproof [8030h], Empty, Empty} }
    ...
    ("Weapon (Yuna): Soft Ring I",            ItemClassification.useful, 0x0039),  # Offset=03A4 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Stone Ward [8039h], HP +5% [8072h]} }
    ...
    ("Weapon (Yuna): Tetra Ring I",           ItemClassification.useful, 0x003e),  # Offset=03F4 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=1 {HP +10% [8073h]} }
    ...
    ("Weapon (Yuna): Soft Ring II",            ItemClassification.useful, 0x0040),  # Offset=0414 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Stoneproof [8038h], Empty} }
    ...
    ("Weapon (Yuna): Tetra Ring II",           ItemClassification.useful, 0x0047),  # Offset=0484 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {HP +10% [8073h], Empty} }
