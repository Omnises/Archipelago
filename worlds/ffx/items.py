...
equip_items: list[ItemData] = [ItemData(x[0], x[1], x[2] | equipItemOffset) for x in [
    ...
    ("Weapon (Auron): Serene Bracer",       ItemClassification.useful, 0x000f),  # Offset=0104 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {HP +5% [8072h], Berserk Ward [8051h]} }
    ("Weapon (Lulu): Bright Bangle",        ItemClassification.useful, 0x0010),  # Offset=0114 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Dark Ward [8049h], Empty} }
    ("Weapon (Yuna): Serum Ring",           ItemClassification.useful, 0x0011),  # Offset=0124 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Lightning Ward [8027h], Poison Ward [803Dh]} }
    ("Weapon (Kimahri): Serene Armlet",     ItemClassification.useful, 0x0012),  # Offset=0134 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Dark Ward [8049h], Berserk Ward [8051h]} }
    ...
    ("Weapon (Yuna): Lucid Ring",           ItemClassification.useful, 0x0015),  # Offset=0164 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Silence Ward [8045h], Confuse Ward [804Fh]} }
    ("Weapon (Tidus): Avenger",             ItemClassification.useful, 0x0016),  # Offset=0174 Weapon [00h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=1 {Counterattack [8003h]} }
    ...
    ("Weapon (Rikku): Shell Targe",         ItemClassification.useful, 0x0018),  # Offset=0194 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=1 {SOS Shell [8059h]} }
    ("Weapon (Kimahri): Lucid Armlet",      ItemClassification.useful, 0x0019),  # Offset=01A4 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=4 {Poison Ward [803Dh], Confuse Ward [804Fh], Silence Ward [8045h], Empty} }
    ...
    ("Weapon (Tidus): Avenger",             ItemClassification.useful, 0x001f),  # Offset=0204 Weapon [00h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=1 {Counterattack [8003h]} }
    ...
    ("Weapon (Kimahri): Knight Lance",      ItemClassification.useful, 0x0021),  # Offset=0224 Weapon [00h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=3 {Strength +3% [8062h], Strength +5% [8063h], Strength +10% [8064h]} }
    ("Weapon (Yuna): Lucid Ring",           ItemClassification.useful, 0x0022),  # Offset=0234 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=3 {Silence Ward [8045h], Confuse Ward [804Fh], Poison Ward [803Dh]} }
    ...
    ("Weapon (Kimahri): Tetra Armlet",      ItemClassification.useful, 0x0026),  # Offset=0274 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=4 {HP +10% [8073h], Empty, Empty, Empty} }
    ...
    ("Weapon (Auron): Defending Bracer",    ItemClassification.useful, 0x0028),  # Offset=0294 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Stoneproof [8038h], Poisonproof [803Ch]} }
    ...
    ("Weapon (Yuna): Recovery Ring",        ItemClassification.useful, 0x002a),  # Offset=02B4 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=1 {HP Stroll [801Bh]} }
    ("Weapon (Rikku): Spiritual Targe",     ItemClassification.useful, 0x002b),  # Offset=02C4 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=1 {MP Stroll [801Ch]} }
    ("Weapon (Auron): Defending Bracer",    ItemClassification.useful, 0x002c),  # Offset=02D4 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Silenceproof [8044h], Darkproof [8048h]} }
    ...
    ("Weapon (Kimahri): Defending Armlet",  ItemClassification.useful, 0x002e),  # Offset=02F4 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=4 {Stoneproof [8038h], Poisonproof [803Ch], Empty, Empty} }
    ("Weapon (Yuna): Phantom Ring",         ItemClassification.useful, 0x002f),  # Offset=0304 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=4 {Ice Eater [8025h], Fire Eater [8021h], Lightning Eater [8029h], Empty} }
    ...
    ("Weapon (Yuna): Phantom Ring",         ItemClassification.useful, 0x0033),  # Offset=0344 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=4 {Water Eater [802Dh], Fire Eater [8021h], Lightning Eater [8029h], Empty} }
    ...
    ("Weapon (Auron): Defending Bracer",    ItemClassification.useful, 0x0035),  # Offset=0364 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=4 {Darkproof [8048h], Deathproof [8030h], Empty, Empty} }
    ...
    ("Weapon (Yuna): Soft Ring",            ItemClassification.useful, 0x0039),  # Offset=03A4 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Stone Ward [8039h], HP +5% [8072h]} }
    ("Weapon (Tidus): Variable Steel",      ItemClassification.useful, 0x003a),  # Offset=03B4 Weapon [00h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Strength +3% [8062h], Strength +5% [8063h]} }
    ...
    ("Weapon (Yuna): Tetra Ring",           ItemClassification.useful, 0x003e),  # Offset=03F4 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=1 {HP +10% [8073h]} }
    ("Weapon (Tidus): Variable Steel",      ItemClassification.useful, 0x003f),  # Offset=0404 Weapon [00h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=4 {Strength +3% [8062h], Empty, Empty, Empty} }
    ("Weapon (Yuna): Soft Ring",            ItemClassification.useful, 0x0040),  # Offset=0414 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Stoneproof [8038h], Empty} }
    ...
    ("Weapon (Yuna): Red RIng",             ItemClassification.useful, 0x0043),  # Offset=0444 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {HP +10% [8073h], Fire Ward [801Fh]} }
    ("Weapon (Lulu): Tetra Bangle",         ItemClassification.useful, 0x0044),  # Offset=0454 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {HP +20% [8074h], Empty} }
    ("Weapon (Tidus): Yellow Shield",       ItemClassification.useful, 0x0045),  # Offset=0464 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Lightningproof [8028h], Empty} }
    ...
    ("Weapon (Yuna): Tetra Ring",           ItemClassification.useful, 0x0047),  # Offset=0484 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {HP +10% [8073h], Empty} }
    ("Weapon (Rikku): Victorious",          ItemClassification.useful, 0x0048),  # Offset=0494 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=4 {Lightningproof [8028h], Fireproof [8020h], Iceproof [8024h], Empty} }
    ...
    ("Weapon (Yuna): Echo Ring",            ItemClassification.useful, 0x004a),  # Offset=04B4 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {HP +10% [8073h], Silence Ward [8045h]} }
    ...
    ("Weapon (Lulu): Phantom Bangle",       ItemClassification.useful, 0x004d),  # Offset=04E4 Armor [01h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=2 {Ice Eater [8025h], Fire Eater [8021h], !Water Eater [802Dh]} }
    ...
    ("Weapon (Kimahri): Knight Lance",      ItemClassification.useful, 0x0052),  # Offset=0534 Weapon [00h], Formula=STR vs DEF [01h], Power=16, Crit=3%, Slots=4 {Strength +10% [8064h], Strength +5% [8063h], Strength +3% [8062h], Empty} }
